package com.example.util.simpletimetracker.feature_settings.exportIcsS3Options.viewModel
...
@HiltViewModel
class ExportIcsS3OptionsViewModel @Inject constructor(
    ...
    private suspend fun loadContent(): List<ViewHolderType> {
        return settingsExportViewDataInteractor.executeIcsS3Options()
    }
}
