...
enum class SettingsBlock {
    ...
    ExportIcsS3Settings,
    ExportIcsS3Endpoint,
    ExportIcsS3AccessKey,
    ExportIcsS3SecretKey,
    ExportIcsS3Bucket,
    ExportIcsS3Region,
    ExportIcsS3Timeout,
    ExportIcsS3Addressing,
    ExportIcsS3TlsVerify,
    ExportIcsS3ObjectKey,
    ExportIcsS3Upload,
    ExportIcsS3PullToRefresh,
    ExportIcsS3Automatic,
    ExportIcsS3AutomaticHint,
    ExportIcsS3AutomaticTime,
    ExportCustomized,
